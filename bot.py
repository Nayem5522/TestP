...
"""
# [MODIFIED] Admin panel HTML with improved design and English UI
admin_html = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="admin-container">
    ...
    <!-- [MODIFIED] Add New Content form with Poster Badge field -->
    ...
    <form method="post" action="{{ url_for('admin') }}">
        ...
        <div id="movie_fields">
            <fieldset><legend>Movie Links</legend>
                ...
                <p><b>OR</b> Direct Download Links</p>
...
# [MODIFIED] Admin route to handle Poster Badge on creation
...
def admin():
    if request.method == "POST":
        ...
        # Using .strip() and `or None` for cleaner data
        ...
        movie_data = {
            ...
            "poster": PLACEHOLDER_POSTER, # Poster will be fetched later
            "overview": "",
            "is_trending": False,
            "is_coming_soon": False,
            "links": [], "files": [], "episodes": [], "season_packs": [], 
        ...
        # Attempt to fetch full details from TMDb in the background
        # For a more robust system, this could be a background job
...
def edit_movie(movie_id):
    ...
    if request.method == "POST":
        ...
        # If TMDb details are missing, try fetching them now
        ...
        if content_type == "movie":
            ...
            update_data["links"] = [{"quality": q, "url": u} for q, u in [("480p", request.form.get("link_480p")), ("720p", request.form.get("link_720p")), ("1080p", request.form.get("link_1080p"))] if u.strip()]

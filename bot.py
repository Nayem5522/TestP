...
<title>PmwBD - Your Entertainment Hub with Prime</title>
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* [MODIFIED] Poster Badge CSS for Red Background / White Text */
  .poster-badge {
    position: absolute;
    top: 10px;
    left: 10px;
...
# [REMOVED] This route is no longer needed as the feature was removed from the UI.
